...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 03, 2021 at 08:05 AM
...
(18, 'Tomatoes', '18062021204101.jpg', '40', 7),
...
INSERT INTO `manage_cart` (`mc_id`, `user_id`, `item_id`) VALUES
(1, 2, 10),
(2, 2, 10),
(3, 2, 12),
(4, 2, 13),
...
(5, 'Bablu Kumar Mahato', 'bablumahato1234@gmail.com', '8215700045', 'About website log In', 'After Login Some php error has occurred.\r\nSo,try to modify your code'),
...
(1, 'Shubham Kr', 'Das', 'shubham1999@gmail.com', '9155025343', '5559e198d7a24841cae9cf5bf1f1d89e', 'Bokaro ', '2021-07-01 09:49:29', '2021-06-14 18:00:41'),
...
(4, 'Sujit ', 'Rana', 'sujit1234@gmail.com', '9608458230', '25f9e794323b453885f5181f1b624d0b', 'Jamshedpur', '2021-06-21 05:32:02', '2021-06-21 05:32:02');
...
--
ALTER TABLE `manage_cart`
  MODIFY `mc_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
